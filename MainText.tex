...
\begin{document}
	...
	\begin{thebibliography}{}
		\bibitem{EPFL} \href{https://dcg.epfl.ch/wp-content/uploads/2018/10/9-NPHardness.pdf}{Chair of Combinatorial Geometry, EPFL — Lectures on Computational Complexity Theory}
		\bibitem{UniBonn} \href{http://theory.cs.uni-bonn.de/info5/steinerkompendium/netcompendium.pdf}{M.Hauptmann, M.Karpinski; Universität Bonn - A Compendium On Steiner Tree Problems}
		\bibitem{UniUtrecht} \href{http://www.cs.uu.nl/docs/vakken/an/teoud/an-steiner.ppt}{Universiteit Utrecht — Презентация приближённых алгоритмов поиска дерева Штейнера}
		\bibitem{IFMO} 
		...
		\bibitem{TUBerlin} \href{https://fpt.akt.tu-berlin.de/publications/steiner-tree-betzler06.pdf}{N. Betzler; Universität Tübingen — "Steiner Tree Problems in the Analysis of Biological Networks"}
		\bibitem{Princeton} \href{https://homepage.univie.ac.at/ivana.ljubic/research/STP/realworld-stp-report-short.pdf}{Markus Leitner, Ivana Ljubić et al.; Princeton — "New Real-world Instances for the Steiner Tree Problem in Graphs"}
		\bibitem{Hungary} \href{http://web.cs.elte.hu/~berkri/Theses/Biro.pdf}{Regina Krisztina Bíró, Eötvös Loránd University — "Constructing Phylogenetic Trees"}
	\end{thebibliography}
\end{document}     